...
const WalletSidebar = ({ isOpen, onClose, onOpen }: WalletSidebarProps) => {
  ...
  return (
    <>
      ...
      <Button
        ...
        className={`fixed top-1/2 -translate-y-1/2 h-10 w-10 p-0 rounded-full bg-background/95 backdrop-blur-sm border border-border/50 hover:bg-lime-500/20 hover:border-lime-500/50 hover:text-lime-500 shadow-lg hover:shadow-lime-500/20 transition-all duration-500 ease-out z-[60] group ${
          isOpen 
            ? "right-[calc(100%-2.5rem)] sm:right-[calc(420px-2.5rem)] md:right-[calc(460px-2.5rem)]" 
            : "right-0 translate-x-0"
        }`}
        title={isOpen ? "Close wallet" : "Open wallet"}
      >
        <ChevronLeft className={`w-5 h-5 group-hover:scale-110 transition-all duration-500 ${
          isOpen ? "" : "rotate-180"
        }`} />
      </Button>
      ...
      {/* Sidebar - macOS style */}
      <div
        className={`fixed top-0 right-0 h-full w-full sm:w-[420px] md:w-[460px] bg-background/98 backdrop-blur-2xl border-l border-border/30 z-50 shadow-2xl transform transition-all duration-500 ease-out ${
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="px-4 sm:px-6 py-4 sm:py-6">
            <div className="flex items-start justify-between mb-4 sm:mb-6">
              <div className="flex items-center gap-2 sm:gap-3">
                <Avatar className="w-12 h-12 sm:w-14 sm:h-14 ring-2 ring-border/50">
                  <AvatarImage src={userProfile?.avatar} />
                  <AvatarFallback className="bg-gradient-to-br from-primary/20 to-purple-500/20 text-primary text-base sm:text-lg font-semibold">
              ...
              <Button
                variant="ghost"
                size="sm"
                className="h-9 w-9 sm:h-10 sm:w-10 p-0 hover:bg-accent/50 rounded-full transition-all"
                onClick={() =>
                  window.open(
            ...
            <div className="relative mb-4 sm:mb-5 rounded-2xl sm:rounded-3xl overflow-hidden">
              ...
              <div className="relative z-10 p-4 sm:p-6">
                <div className="text-xs sm:text-sm text-black dark:text-foreground/70 mb-1 sm:mb-2 font-medium">
                  Current Balance
                </div>
                <div className="flex items-baseline gap-2 sm:gap-3 mb-1">
                  <div className="text-3xl sm:text-4xl font-bold tracking-tight text-black dark:text-foreground">
            ...
            <div className="grid grid-cols-2 gap-2 sm:gap-3">
              <Button
                className="h-10 sm:h-12 bg-primary hover:bg-primary/90 rounded-xl sm:rounded-2xl font-semibold shadow-lg shadow-primary/20 transition-all hover:scale-[1.02] text-sm sm:text-base"
              ...
              <Button
                variant="outline"
                className="h-10 sm:h-12 border-2 border-border/50 hover:bg-accent/50 rounded-xl sm:rounded-2xl font-semibold transition-all hover:scale-[1.02] text-sm sm:text-base"
          ...
          >
            <div className="flex items-center justify-between px-4 sm:px-6 py-2 sm:py-3 border-b border-border/20">
              <TabsList className="bg-transparent h-auto p-0 gap-3 sm:gap-6 flex-1">
                <TabsTrigger 
                  value="tokens" 
                  className="rounded-none data-[state=active]:bg-transparent data-[state=active]:shadow-none data-[state=active]:text-foreground border-b-2 border-transparent data-[state=active]:border-foreground font-semibold text-xs sm:text-base tracking-tight transition-all text-muted-foreground pb-1.5 sm:pb-2"
                >
                  Holdings
                </TabsTrigger>
                <TabsTrigger 
            ...
            <TabsContent value="tokens" className="flex-1 overflow-y-auto scrollbar-thin px-4 sm:px-6 py-3 sm:py-4 space-y-2 sm:space-y-3 mt-0">
