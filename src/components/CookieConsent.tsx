...
export const CookieConsent = () => {
  ...
  useEffect(() => {
    // Delay showing banner to avoid showing during loading screen
    const delayTimer = setTimeout(() => {
      setIsReady(true);
    }, 3000); // Wait 3 seconds (loading screen is 2.8s)
  ...
  useEffect(() => {
    ...
    console.log('🍪 [CookieConsent] Has consent:', hasConsent);
    console.log('🍪 [CookieConsent] Show banner:', !hasConsent);
  ...
  if (!showBanner) {
    console.log('🍪 [CookieConsent] Banner hidden - user already gave consent');
    return null;
  }
  ...
  return (
    <>
      ...
      <div className="fixed bottom-4 left-4 right-4 md:left-auto md:right-6 md:bottom-6 z-[9999] pointer-events-none">
