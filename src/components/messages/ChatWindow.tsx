...
export default function ChatWindow({
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {!hideHeader && (
        <div className="px-4 md:px-6 py-3 md:py-4 border-b border-border bg-card md:bg-transparent">
      ...
      {/* Input */}
      <div className="px-3 md:px-6 py-3 md:py-4 border-t border-border bg-card md:bg-transparent">
        {editingMessageId && (
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="w-10 h-10 md:w-11 md:h-11 rounded-full bg-muted/50 flex items-center justify-center hover:bg-muted active:bg-muted transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex-shrink-0"
            title="Upload image"
          >
            {uploadingMedia ? (
          ...
          <button
            ...
            className="w-10 h-10 md:w-11 md:h-11 rounded-full bg-muted/50 flex items-center justify-center hover:bg-muted active:bg-muted transition-colors flex-shrink-0"
            title="Upload file"
          >
            <svg className="w-5 h-5 text-foreground" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <Button
            ...
            size="icon"
            className="h-10 w-10 md:h-11 md:w-11 rounded-full flex-shrink-0 bg-primary hover:bg-primary/90"
          >
            {editing ? (
