      ...
      <main className="pt-16">
        <div className="container mx-auto px-3 md:px-6 py-4 md:py-6">
          ...
          <div className="flex items-center justify-between mb-4 md:mb-6">
            <div>
              <h1 className="font-clash font-semibold text-xl md:text-3xl mb-1 md:mb-2">My Playlists</h1>
                ...
                <CardContent className="p-0">
                  <div className="relative">
                    ...
                    <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center rounded-t-lg">
                      <Button
                        size="lg"
                        className="rounded-full w-8 h-8 md:w-12 md:h-12 bg-white/20 hover:bg-white/30 backdrop-blur-sm border-0"
                      >
                      ...
                      <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                          <Button
                            size="sm"
                            variant="secondary"
                            className="w-6 h-6 md:w-8 md:h-8 p-0 bg-black/50 hover:bg-black/70 border-0"
                            onClick={(e) => {
                              e.stopPropagation();
                            }}
                          >
                  ...
                  <div className="p-2 md:p-4">
                    <h3 className="font-semibold text-xs md:text-lg mb-0.5 md:mb-1 truncate">{playlist.title}</h3>
                    <p className="text-[10px] md:text-sm text-muted-foreground mb-1 md:mb-3 line-clamp-1 md:line-clamp-2">{playlist.description}</p>
                    ...
                    <div className="flex items-center justify-between md:hidden text-[10px] text-muted-foreground mb-1">
                      <span>{playlist.tracks.length} tracks</span>
                    </div>
